...
@Component({
  selector: 'app-edit-personnel-area',
  standalone: false,
  templateUrl: './edit-personnel-area.html',
  styleUrl: './edit-personnel-area.scss'
})
export class EditPersonnelArea implements OnInit {
  form: FormGroup;
  id!: number;
  loading: WritableSignal<boolean> = signal(false);

  constructor(fb: FormBuilder, private service: PersonnelAreasService, private route: ActivatedRoute, private router: Router, private msg: NzMessageService) {
